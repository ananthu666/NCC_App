    ...
    const addcampcredit = async () => {
      ...
      try {
        ...
        const data = {
          ...
          ta_off: formValues.ta_off||'2300',
          messing_off: formValues.messing_off||'5400',
          messing_cad: formValues.messing_cad||'2108',
          incidentials: formValues.incidentials||'4340',
          rank_pay: formValues.rank_pay||'1910',
          ta_da_civil: formValues.ta_da_civil||'1540',
          pol: formValues.pol||'7383',
          ...
          camp_id: camp_id,
          ship_modelling: formValues.ship_modelling||'1432',
